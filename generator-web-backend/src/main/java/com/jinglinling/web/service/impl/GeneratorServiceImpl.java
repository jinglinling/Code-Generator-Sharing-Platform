...
import com.jinglinling.web.mapper.GeneratorMapper;
import com.jinglinling.web.model.dto.generator.GeneratorQueryRequest;
...
public class GeneratorServiceImpl extends ServiceImpl<GeneratorMapper, Generator> implements GeneratorService {
    ...
    public QueryWrapper<Generator> getQueryWrapper(GeneratorQueryRequest generatorQueryRequest) {
        ...
        if (StringUtils.isNotBlank(searchText)) {
            queryWrapper.and(qw -> qw.like("name", searchText).or().like("descrption", searchText));
        }
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(userId), "distPath", distPath);
